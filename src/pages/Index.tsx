        ...
        <Card className="shadow-xl border-0 bg-white/95 backdrop-blur-sm">
          <CardHeader className="text-center space-y-6 pb-8">
            ...
            <div className="space-y-2">
              <CardTitle className="text-3xl font-bold text-gray-900">Gestión de Flota</CardTitle>
              <CardDescription className="text-gray-600 text-lg">Sistema de Gestión de Transporte Sanitario</CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="border-t pt-6">
              ...
              <div className="space-y-2">
                {testAccounts.map(account => <Link key={account.email} to="/login" state={{
                email: account.email
              }} className="block">
                    <Button variant="outline" className="w-full justify-between py-3 border-gray-200 hover:bg-blue-50 hover:border-blue-300 transition-colors" size="sm">
